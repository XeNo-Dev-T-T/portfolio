          ...
          <TerminalWindow title="About">
            <div className="space-y-6">
              ...
              <AnimatedSection animation="slide-in-up" delay={5}>
                <div className="mt-8 p-4 bg-secondary/20 rounded-md terminal-hover border border-accent/20">
                  <p className="text-secondary-foreground text-center font-mono relative">
